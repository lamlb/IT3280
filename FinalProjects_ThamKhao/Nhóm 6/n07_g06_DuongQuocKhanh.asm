...
checkSpace: #bo qua , \t space
	...
	beq	$s3, $s0 cutSpace # so sanh ki tu voi space neu phai nhay den cutSpace
	beq	$s3, $t3 cutSpace #  so sanh voi tab neu phai nhay den cutSpace 
	beq	$s3, $s4 cutSpace # so sanh voi dau phay neu phai nhay den cutSpace
	j	cut
